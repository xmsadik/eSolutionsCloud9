  METHOD outgoing_delivery_preview.
    ...
    ELSE.
      lv_xslt_name = 'ZETR_IRSALIYE_GENEL'.
    ENDIF.
    TRY.
        CALL TRANSFORMATION (lv_xslt_name) SOURCE XML iv_document_ubl RESULT XML rv_delivery_data.
...
*          rv_delivery_data = cl_abap_conv_codepage=>create_out( )->convert(
